...
<div class="mainHeadline"><img
	src="{@RELATIVE_WCF_DIR}icon/adminToolsAboutL.png" alt="" />
...
<p class="formField"><a
	href="{@RELATIVE_WCF_DIR}acp/dereferrer.php?url={"
	http://www.wbb3addons.de"|rawurlencode}" class="externalURL">wbb3Addons</a></p>
</div>
...
<p class="formField">Copyright &copy; 2009 Oliver Kliebisch. Admin Tools
...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post"><input
	...
	name="hosted_button_id" value="3346640" /> <input type="image"
	src="https://www.paypal.com/de_DE/DE/i/btn/btn_donateCC_LG.gif"
