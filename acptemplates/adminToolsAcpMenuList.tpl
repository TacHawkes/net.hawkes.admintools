...
<ul>
	<li><a
		href="index.php?form=AdminToolsMenuAdd&amp;packageID={@PACKAGE_ID}{@SID_ARG_2ND}"><img
		src="{@RELATIVE_WCF_DIR}icon/adminToolsMenuLinkM.png" alt=""
		title="{lang}wcf.acp.headerItem.add{/lang}" /> <span>{lang}wcf.acp.admintools.acpmenu.add{/lang}</span></a></li>
</ul>
</div>
</div>
<p class="info">{lang}wcf.acp.admintools.acpmenu.editinfo{/lang} {if
$items|count > 0}
</div>
<div class="sitemap">{acpmenumap menuItemData=$items} {/if} {include
file='footer'}